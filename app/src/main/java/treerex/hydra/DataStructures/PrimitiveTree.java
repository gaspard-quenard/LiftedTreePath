...
public class PrimitiveTree {
    ...
    public ArrayList<HashSet<Integer>> getParentsNodesIdx() {
        return this.parentsNodesIdx;
    }

    public ArrayList<HashSet<Integer>> getChildrenNodesIdx() {
        return this.childrenNodesIdx;
    }

    public HashSet<Integer> getRootNodesIdx() {
        return this.rootNodesIdx;
    }
    ...
    public HashSet<Integer> getChildrenIdx(Integer idxNode) {
        return this.childrenNodesIdx.get(idxNode);
    }

    public HashSet<Integer> getParentsIdx(Integer idxNode) {
        return this.parentsNodesIdx.get(idxNode);
    }
